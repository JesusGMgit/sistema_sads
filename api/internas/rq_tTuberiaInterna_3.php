...
function get_tubos()
{
    $sql = "SELECT * FROM tuberia_soldadura_interna_3";
    global $conn;
...
{
    $sql = "SELECT * FROM tuberia_soldadura_interna_3 WHERE Tin_ID_tubo=" . $T_ID_tubo . "";
    global $conn;
    $query = $conn->query($sql);
    $data = array();
    while ($r = $query->fetch_assoc()) {
...
function get_tubos_fecha($T_fecha= "")
{
    ...
    $sql = "SELECT * FROM tuberia_soldadura_interna_3 WHERE Tin_Fecha=\"" . $T_fecha . "\"";
...
function get_tubos_proyecto($T_proyecto=0,$T_maquina="")
{
    ...
    $sql = "SELECT * FROM tuberia_soldadura_interna_3 WHERE Tin_ID_proyecto=\"". $T_proyecto."\"";
...
function insert_tubo()
{
    ...
    $sql = "INSERT INTO tuberia_soldadura_interna_3 (Tin_ID_tubo,Tin_No_tubo,Tin_No_placa,Tin_ID_proyecto,Tin_Lote_alambre,Tin_Lote_fundente,Tin_FolioOperador,Tin_Fecha,Tin_Hora,Tin_Hora_db,Tin_Archivos_excel,Tin_Observaciones)
...
function update_tubo()
{
    ...
    global $conn;
    $sql="UPDATE tuberia_soldadura_interna_3 SET Tin_Archivos_excel='".$T_Archivos_excel."' WHERE Tin_ID_tubo=".$id_tubo;
...
function update_reporte()
{
    ...
    global $conn;
    $sql="UPDATE tuberia_soldadura_interna_3 SET Tin_Reporte_excel='".$T_nombre_reporte."' WHERE Tin_ID_tubo=".$id_tubo;
...
function update_tuberia(){
    ...
    global $conn;
    $sql = "UPDATE tuberia_soldadura_interna_3 SET Tin_No_tubo='" . $T_no_tubo . "', Tin_No_placa='" . $T_no_placa . "', Tin_ID_proyecto='" . $T_ID_proyecto. "', 
    Tin_Lote_alambre='" . $T_lote_alambre . "', Tin_Lote_fundente='".$T_lote_fundente."',Tin_FolioOperador='".$T_foliooperador."',
...
function update_hora_db()
{
    ...
    global $conn;
    $sql="UPDATE tuberia_soldadura_interna_3 SET Tin_Hora_db='".$T_hora_db."' WHERE Tin_ID_tubo=".$id_tubo;
...
function delete_tubo($T_ID_tubo)
{
    ...
    $sql = "DELETE FROM tuberia_soldadura_interna_3 WHERE Tin_ID_tubo=" . $T_ID_tubo;
