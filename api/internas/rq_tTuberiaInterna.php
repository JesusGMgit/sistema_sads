...
function get_tubos()
{
    $sql = "SELECT * FROM tuberia_soldadura_interna";
    global $conn;
...
{
    $sql = "SELECT * FROM tuberia_soldadura_interna WHERE Tin_ID_tubo=" . $T_ID_tubo . "";
    global $conn;
    $query = $conn->query($sql);
    $data = array();
    while ($r = $query->fetch_assoc()) {
...
{
    if($T_maquina!=""){
        $sql = "SELECT Tin_ID_tubo,Tin_No_tubo,Tin_No_placa,Tin_ID_proyecto,Tin_Lote_alambre,Tin_Lote_fundente,Tin_Maquina,Tin_FolioOperador,Tin_Fecha,Tin_Hora,Tin_Archivo_Fexcel,Tin_Archivos_excel
        FROM tuberia_soldadura_interna WHERE Tin_Fecha=\"" . $T_fecha . "\" AND Tin_Maquina=\"".$T_maquina."\"";
    }else{
        $sql = "SELECT Tin_ID_tubo,Tin_No_tubo,Tin_No_placa,Tin_ID_proyecto,Tin_Lote_alambre,Tin_Lote_fundente,Tin_Maquina,Tin_FolioOperador,Tin_Fecha,Tin_Hora,Tin_Archivo_Fexcel,Tin_Archivos_excel
        FROM tuberia_soldadura_interna WHERE Tin_Fecha=\"" . $T_fecha . "\"";
    }
    global $conn;
    $query = $conn->query($sql);
    $data = array();
...
function get_tubos_proyecto($T_proyecto=0,$T_maquina="")
{
    //echo $T_proyecto." ";
    if($T_maquina!=""){
        $sql = "SELECT Tin_ID_tubo,Tin_No_tubo,Tin_No_placa,Tin_ID_proyecto,Tin_Lote_alambre,Tin_Lote_fundente,Tin_Maquina,Tin_FolioOperador,Tin_Fecha,Tin_Hora,Tin_Archivo_Fexcel
        FROM tuberia_soldadura_interna WHERE Tin_ID_proyecto=\"". $T_proyecto."\" AND Tin_Maquina=\"".$T_maquina."\"";
    }else{
        $sql = "SELECT Tin_ID_tubo,Tin_No_tubo,Tin_No_placa,Tin_ID_proyecto,Tin_Lote_alambre,Tin_Lote_fundente,Tin_Maquina,Tin_FolioOperador,Tin_Fecha,Tin_Hora,Tin_Archivo_Fexcel 
        FROM tuberia_soldadura_interna WHERE Tin_ID_proyecto=\"". $T_proyecto."\"";
    }
...
function insert_tubo()
{
    ...
    $sql = "INSERT INTO tuberia_soldadura_interna (Tin_ID_tubo,Tin_No_tubo,Tin_No_placa,Tin_ID_proyecto,Tin_Lote_alambre,Tin_Lote_fundente,Tin_Maquina,Tin_FolioOperador,Tin_Fecha,Tin_Hora,Tin_Archivos_excel,Tin_Observaciones)
    VALUES ('$id_tubo','$T_no_tubo','$T_no_placa','$T_ID_proyecto','$T_lote_alambre','$T_lote_fundente','$T_maquina','$T_foliooperador','$T_fecha','$T_hora','$Archivos_excel', '$T_observaciones')";
...
function update_tubo()
{
    ...
    global $conn;
    $sql="UPDATE tuberia_soldadura_interna SET Tin_Archivos_excel='".$T_Archivos_excel."' WHERE Tin_ID_tubo=".$id_tubo;
...
function update_reporte()
{
    ...
    //echo " " . $id_tubo ." ". $T_Archivos_excel;
    global $conn;
    $sql="UPDATE tuberia_soldadura_interna SET Tin_Archivo_Fexcel='".$T_nombre_reporte."' WHERE Tin_ID_tubo=".$id_tubo;
    //$sql = "UPDATE Tuberia SET T_no_tubo='" . $T_no_tubo . "', T_no_placa='" . $T_no_placa . "', T_nom_proyecto='" . $T_nom_proyecto. ", 
    //T_lote_alambre='" . $T_lote_alambre . "', T_lote_fundente='".$T_lote_fundente."',T_maquina='".$T_maquina."',
    //T_fecha='".$T_fecha."',T_hora='".$T_hora."',archivos_excel='".$T_Archivos_excel."' WHERE P_nombre=" . $T_no_tubo;
...
function update_tuberia(){
    ...
    //echo " " . $id_tubo ." ". $T_Archivos_excel;
    global $conn;
    $sql = "UPDATE tuberia_soldadura_interna SET Tin_No_tubo='" . $T_no_tubo . "', Tin_No_placa='" . $T_no_placa . "', Tin_ID_proyecto='" . $T_ID_proyecto. "', 
...
function delete_tubo($T_no_tubo)
{
    ...
    $sql = "DELETE FROM tuberia_soldadura_interna WHERE Tin_No_tubo=" . $T_no_tubo;
